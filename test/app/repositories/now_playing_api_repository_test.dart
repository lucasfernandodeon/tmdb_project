...
import 'package:tmdb_project/app/core/constants.dart';
...
main() {
  ...
  test("deve retornar uma entidade de nowPlayingResponseModel", () async{

    final response = await nowPlayingRepository.getNowPlaying(page: 1);
    expect(response,  isA<NowPlayingResponseModel>() );
  });
}

const Map _nowPlayingData= {
